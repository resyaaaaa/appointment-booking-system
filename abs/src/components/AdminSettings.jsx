...
export default function AdminSettings({
  ...
  const [contactEmail, setContactEmail] = useState(settings.contactEmail || 'contact@example.com');
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl border border-slate-202 p-6 shadow-sm">
      <div className="flex items-center gap-2 pb-4 border-b border-slate-100 mb-5">
        ...
        <div>
          <h4 className="font-display font-semibold text-slate-905 text-sm">Profile &amp; Settings</h4>
